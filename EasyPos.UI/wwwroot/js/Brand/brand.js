            ...
            { 'data': "name",},
            {
                ...
                "render": function (data, type, full, meta) {
                    return '<div class="dropdown action-button mx-2">'
                        ...
                        + '<li><a  href="/Brands/Upsert?Id=' + data + '" class="dropdown-item text-warning"><i class="fa-solid fa-pen-to-square"></i> Edit </a></li>'
